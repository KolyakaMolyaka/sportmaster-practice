...
public class QuizzesRepository implements IQuizzesRepository {
    private HashMap<Integer, QuizData> quizzesMap = new HashMap<Integer, QuizData>() {{
        put(1, new QuizData(nextId(), "Мастер шахмат",
                ...
                "Шахматы", "Легкий"));
        put(2, new QuizData(nextId(), "История борьбы",
        ...
        put(3, new QuizData(nextId(), "Водные гонки",
        ...
        put(4, new QuizData(nextId(), "\"Бег, прыжки, метания: в мире легкой атлетики",
